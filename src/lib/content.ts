...
export const projects = [
  {
    ...
    github: "https://github.com/RISHABH12005/LMS.git",
    bullets: [
...
export const galleryItems = [
  { id: 1, title: "HACKNIT 7.0", meta: "RANK 1 · 6,200+ · 20 COUNTRIES", description: "International hackathon. Built dual-component IoT livestock monitoring system. Pitched commercialisation strategy, competitive analysis, and ROI case to a global jury. Sole presenter for the team.", img: "https://images.unsplash.com/photo-1578269174936-2709b5a19083?w=800&auto=format&fit=crop&q=80" },
  { id: 2, title: "HACKSAGON 2025", meta: "FIRST RUNNER-UP · NATIONAL", description: "National hackathon focused on AgriTech innovation. Outlined go-to-market strategy and financial viability analysis to domain expert panel. Recognised for Product Thinking.", img: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=800&auto=format&fit=crop&q=80" },
  { id: 3, title: "BHOPAL VIGYAN MELA 2024", meta: "4 PROJECTS · 4 DAYS · NATIONAL", description: "4-day national science exhibition. Showcased 4 projects across domains. Built cross-industry professional networks and represented JUET at national stage.", img: "https://images.unsplash.com/photo-1531482615713-2afd69097998?w=800&auto=format&fit=crop&q=80" },
  { id: 4, title: "TACHYON 2025", meta: "ORGANIZER · 2,000+ ATTENDEES", description: "University annual tech-fest. Oversaw logistics, sponsorship outreach, and partner coordination. Event reached 2,000+ attendees.", img: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&auto=format&fit=crop&q=80" },
  { id: 5, title: "UNIVERSITY IDEATHON 2024", meta: "1ST PLACE · 30+ TEAMS", description: "University-level ideathon. Defended a structured business case against 30+ competing teams. Won 1st Place.", img: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=800&auto=format&fit=crop&q=80" },
  { id: 6, title: "JUET NATIONAL CONFERENCE", meta: "PUBLISHED · 100+ ATTENDEES", description: "Authored and presented a research paper on Social Sciences and Library Sciences. Communicated findings to an audience of 100+ attendees.", img: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&auto=format&fit=crop&q=80" },
  { id: 7, title: "OFF-STAGE LEADERSHIP", meta: "JOINT SECRETARY · VRARMR CLUB", description: "Joint Secretary of VRARMR Club at JUET — led a 50+ member club, ran screening interviews for 20+ candidates. Active across Bitwise, Mozilla, NSS, and BIS clubs.", img: "https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=800&auto=format&fit=crop&q=80" },
];

export const skillContributions: Record<string, string> = {
  "Business Development": "Led BD at Trustique Assists; drove 30% user growth through market intelligence and partner discovery sessions.",
  ...
  "Lead Generation": "Sourced and onboarded 20+ interns across multiple colleges at Trustique Assists.",
  "Flutter": "Developed cross-platform ARound You app integrating Map Tiles API and Firebase database.",
  ...
  "Git/GitHub": "Version control across all 4 shipped projects; collaborative workflows at Trustique Assists.",
  "Android Studio": "Primary IDE utilized for cross-platform Flutter and Android development.",
  "SQL": "Managed relational databases, schemas, and query optimization for university projects and coursework.",
  "MS Excel": "Data cleaning and EDA for ML model at Skill Dzire; sales pattern analysis for Superstore consultancy.",
  "MS PowerPoint": "Created award-winning pitch decks and slide presentations for national and international hackathons.",
  "Agile Methodology": "Directed 3 cross-functional teams (15–18 members each) using Agile practices at Trustique Assists.",
  "Machine Learning (EDA)": "Certified by Skill Dzire; delivered 15% model classification accuracy improvement.",
  "Google Cloud Platform": "Certified in GCP; utilized cloud services for scalable app deployment and storage.",
};
...
export const skills = [
  ...
  { number: "03", category: "DATA & TOOLS", items: ["SQL", "MS Excel", "MS PowerPoint", "Agile Methodology", "Machine Learning (EDA)", "Google Cloud Platform"] },
];
